...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="<?=site_url('generate_migration/init');?>">Inital Setup</a></li>
        <li role="presentation"><a href="<?=site_url('generate_migration/generic');?>">Generic Script</a></li>
    </ul>
</div>
<!-- .container-fluid end -->
